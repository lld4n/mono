      ...
      <div className={styles['right-side']}>
        ...
        <div className={styles['room__chat']}>
          <div className={styles['room__messages']}>
            <div className={styles['room__message']}>
              <div className={styles['message-date']}>16:23</div>
              <div className={styles['message-author']}>lldan</div>
              <div className={styles['message-text']}>Куплю гараж недорого</div>
            </div>
            <div className={styles['room__message']}>
              <div className={styles['message-date']}>16:23</div>
              <div className={styles['message-author']}>lldan</div>
