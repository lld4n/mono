...
import Admin from "@/components/Room/PlayersList/Admin/Admin";
import NoAdmin from "@/components/Room/PlayersList/NoAdmin/NoAdmin";
...
export default function PlayersList({ players, game, playerId }: PropsType) {
